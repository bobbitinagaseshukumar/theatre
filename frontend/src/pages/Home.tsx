                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  ...
                  <div className="mt-5 pt-4 border-t border-white/5 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded bg-primary hover:bg-primary-hover hover:scale-105 transition-all text-white font-bold text-xs shadow-redGlow cursor-pointer flex items-center gap-1"
                    >
