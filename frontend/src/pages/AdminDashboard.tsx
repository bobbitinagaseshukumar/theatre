                ...
                <tbody className="divide-y divide-white/5 bg-black/20">
                  {moviesList.map((m) => (
                    <tr key={m.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4 text-right"><button onClick={() => handleDeleteMovie(m.id, m.title)} className="p-2 rounded bg-white/5 hover:bg-primary/20 text-gray-400 hover:text-primary transition-colors"><Trash2 className="w-3.5 h-3.5" /></button></td>
                    </tr>
                  ))}
                </tbody>
              </table>
                  ...
                  {showsList.map((show) => (
                    <tr key={show.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4 text-right">
                        ...
                        }} className="p-1 rounded bg-red-500/10 hover:bg-red-500 text-red-400 hover:text-white cursor-pointer transition-colors text-[9px] uppercase font-bold px-2 py-1">Cancel Show</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
